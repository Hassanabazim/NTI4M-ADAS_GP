...
HAL/HLCD/%.o HAL/HLCD/%.su HAL/HLCD/%.cyclo: ../HAL/HLCD/%.c HAL/HLCD/subdir.mk
...
clean: clean-HAL-2f-HLCD

clean-HAL-2f-HLCD:
	-$(RM) ./HAL/HLCD/HLCD_prog.cyclo ./HAL/HLCD/HLCD_prog.d ./HAL/HLCD/HLCD_prog.o ./HAL/HLCD/HLCD_prog.su

.PHONY: clean-HAL-2f-HLCD
